...
class FederatedShareProviderCopy implements IShareProvider
{
  ...
  protected GlobalScaleIConfig $gsConfig;
  protected IAppConfig $appConfig;
  protected ICloudFederationProviderManager $cloudFederationProviderManager;
  ...
  protected array $supportedShareType = [IShare::TYPE_REMOTE_GROUP, IShare::TYPE_REMOTE, IShare::TYPE_CIRCLE];
  ...
  protected function createFederatedShare(IShare $share)
  {
    ...
    try {
      ...
      $this->logger->error("Failed to notify remote server of federated share, removing share: {$e->getMessage()}.", ['federatedfilesharing']);
      $failure = true;
    }
    ...
    if ($failure) {
      ...
      $message_t = $this->l->t(
        'Sharing %1$s failed, could not find %2$s, maybe the server is currently unreachable or uses a self-signed certificate.',
   ...
   * @return int
   */
  protected function addShareToDB($itemSource, $itemType, $shareWith, $sharedBy, $uidOwner, $permissions, $token, $shareType, $expirationDate)
  {
   ...
   * @throws InvalidShare
   */
  protected function getNode($userId, $id)
  {
    try {
  ...
  public function isOutgoingServer2serverShareEnabled()
  {
    ...
    $result = $this->appConfig->getValueString('files_sharing', 'outgoing_server2server_share_enabled', 'yes');
    return ($result === 'yes');
  }
  ...
  public function isIncomingServer2serverShareEnabled()
  {
    ...
    $result = $this->appConfig->getValueString('files_sharing', 'incoming_server2server_share_enabled', 'yes');
    return ($result === 'yes');
  }
  ...
  public function isOutgoingServer2serverGroupShareEnabled()
  {
    ...
    $result = $this->appConfig->getValueString('files_sharing', 'outgoing_server2server_group_share_enabled', 'no');
    return ($result === 'yes');
  }
  ...
  public function isIncomingServer2serverGroupShareEnabled()
  {
    ...
    $result = $this->appConfig->getValueString('files_sharing', 'incoming_server2server_group_share_enabled', 'no');
    return ($result === 'yes');
  }
  ...
  public function isLookupServerQueriesEnabled()
  {
    ...
    $result = $this->appConfig->getValueString('files_sharing', 'lookupServerEnabled', 'yes');
    return ($result === 'yes');
  }
  ...
  public function isLookupServerUploadEnabled()
  {
    ...
    $result = $this->appConfig->getValueString('files_sharing', 'lookupServerUploadEnabled', 'yes');
    return ($result === 'yes');
  }
